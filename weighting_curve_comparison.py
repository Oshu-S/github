...
plt.loglog(f1, W1, color="C0", ls="-.", linewidth=2, label=r"$\it{f_{midStart,0}}$" + "=2.0 Hz (baseline)") # Baseline
plt.loglog(f2, W2, color="C1", ls="--", linewidth=2,  label=r"$\it{f_{midStart}}$" + "=0.1 Hz") # Lower Bound
plt.loglog(f3, W3, color="C2", ls=":", linewidth=2, label=r"$\it{f_{midStart}}$" + "=5.0 Hz") # Upper Bound
...
plt.legend(loc='lower left', bbox_to_anchor=(0.6, 0.05), fontsize=15, framealpha=1.0)
plt.tight_layout()
plt.show()

...
plt.loglog(f1, W1, label="Baseline (standing/sitting, ISO 2631)")
plt.loglog(f2, W2, label="Lower bound (faster pacing, less sensitive)")
plt.loglog(f3, W3, label="Upper bound (slower pacing, more sensitive)")

...
# CHOOSE PARAMETER RANGES FOR SWEEPING HERE (NOT FOR PLOTTING)
param_ranges = {
    "low_gain":   (0.2, 0.6),
    "f_low":      (0.3, 1.0),
    "f_mid_start":(1.5, 3.0),
...
# Sweep all parameters one-at-a-time across defined ranges (defined in param_ranges) (NOT FOR PLOTTING)
